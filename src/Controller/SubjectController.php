...
class SubjectController extends Controller
{
    ...
    {
        return $this->render('subject/show.html.twig', ['subject' => $subject, 'tasks' => $subject->getTasks(),]);
    }
    ...
    public function enroll(Request $request, Subject $subject)
    {
        ...
        $this->addFlash('positivo','Te has inscrito correctamente');
    ...
    public function unenroll(Request $request, Subject $subject)
    {
        ...
        $this->addFlash('positivo','Te has desinscrito correctamente');
